...
import { ABOUT_HIGHLIGHTS } from '@/lib/constants/about-data';

export function About() {
  const t = useTranslations('about');

  return (
    <section className="py-32 relative overflow-hidden bg-gradient-to-b from-transparent via-[rgba(var(--color-primary)/0.02)] to-transparent w-full">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Bottom accent */}
        <AnimatedSection className="mt-16 flex justify-center" delay={0.5} duration={1}>
